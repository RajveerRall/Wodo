...
class Task(ft.UserControl):
    ...
    def start_recording(self):
        ...
        self.recording_thread = threading.Thread(target=self.record_screen, daemon=True, args=())
    ...
    def record_screen(self):
        ...
        self.output = cv2.VideoWriter(os.path.join(self.task_folder, self.video_name), self.fourcc, 30.0, dim)
...
async def main(page: ft.Page):
    ...
    # await page.add_async(app, page.route)
    # def route_change( e: ft.RouteChangeEvent):
    #     page.add_async(ft.Text(f"New route: {e.route}"))
    ...
    # await page.add_async(ft.ElevatedButton("Go to Store", on_click=go_store))
